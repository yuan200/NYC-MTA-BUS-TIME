...
public class Favorite {
    ...
    public Favorite(String mRowId, String mGroupName, String mStopCode1, String mStopCode2, String mStopCode3) {
        this.mRowId = mRowId;
        this.mGroupName = mGroupName;
        this.mStopCode1 = mStopCode1;
        this.mStopCode2 = mStopCode2;
        this.mStopCode3 = mStopCode3;
    }
