package com.wen.android.mtabuscomparison.screens.stopmonitoring;
...
public class SearchResultActivity extends AppCompatActivity {
    ...
    public void addToFavorite() {
        ...
        if (stopCode != null) {
            ...
            Executors.newSingleThreadExecutor().execute(() ->
                    BusDatabase.Companion.getInstance(getApplicationContext()).busListDao().insertAll(favorite));
        }
    ...
    public void removeFromFavorite() {
        int id = (int)mRowID;
        Executors.newSingleThreadExecutor().execute(() ->
                BusDatabase.Companion.getInstance(getApplicationContext()).busListDao().delete(id));
    }
